...
import sys
import threading
from openctp_ctpopt import thosttraderapi as tdapi
# import soptthosttraderapi as tdapi
...
if __name__ == '__main__':
    if len(sys.argv) != 7:
        ...
        print("example: {} tcp://114.94.59.94:46666 8200 xxxxxx 888888 openctp_ticktrader_1.0.0 V2B1CUV2C9RGF1SE".format(
            sys.argv[0]))
        exit(0)
