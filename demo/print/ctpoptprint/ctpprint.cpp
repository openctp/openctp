...
int main(int argc, char* argv[])
{
	...
	strncpy(QryInstrumentMarginRate.ExchangeID, "SZSE", sizeof(QryInstrumentMarginRate.ExchangeID) - 1);
	strncpy(QryInstrumentMarginRate.InstrumentID, "90005264", sizeof(QryInstrumentMarginRate.InstrumentID) - 1);
	...
	strncpy(QryExchangeMarginRate.ExchangeID, "SZSE", sizeof(QryExchangeMarginRate.ExchangeID) - 1);
	strncpy(QryExchangeMarginRate.InstrumentID, "90005264", sizeof(QryExchangeMarginRate.InstrumentID) - 1);
	...
	strncpy(QryExchangeMarginRateAdjust.InstrumentID, "90005264", sizeof(QryExchangeMarginRateAdjust.InstrumentID) - 1);
