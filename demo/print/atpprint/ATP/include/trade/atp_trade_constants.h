// code_generator_tag
// constants:35bfc85522ea8f6825722ef01c8f916e types:aee79c070f38328d3ee5388c310aca3f template:839cad2ddd8770670c0850a75e472b7f code:28d5db60b028badf9dda6a8ea581d17d
...
struct TRADE_API ATPQueryResultCodeConst
{
	...
	static const ATPQueryResultCodeType IPOIsZero = 69;	///<新股额度为零
...
struct TRADE_API ATPRejectReasonCodeConst
{
	...
	static const ATPRejectReasonCodeType kFlowAccessCustIDAndProductIDSpeedReject = 225;	///<客户号和产品号流速超过
	static const ATPRejectReasonCodeType kFlowAccessCustIDAndProductIDSumReject = 226;	///<客户号和产品号流量超过
	static const ATPRejectReasonCodeType kFlowAccessUserIDSpeedReject = 227;	///<用户流速超过
	static const ATPRejectReasonCodeType kFlowAccessUserIDSumReject = 228;	///<用户流量超过
	static const ATPRejectReasonCodeType kFlowAccessAgwSpeedReject = 229;	///<agw流速超过
	static const ATPRejectReasonCodeType kFlowAccessAgwSumReject = 230;	///<agw流量超过
	...
	static const ATPRejectReasonCodeType kAccountSecurityStatus8NonPrivileged = 1016;	///<客户未开通买入退市整理期证券的权限
	...
	static const ATPRejectReasonCodeType kProtectiveStrategyCheckFailed = 1092;	///<认沽期权买入保护性策略校验失败
