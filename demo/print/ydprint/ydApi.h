...
public:
	...
	/// alterMoney,updateMarginRate,adjustAccountMarginModelInfo,updateSpotPosition,updateSpotAlive and updateHoldingExternalFrozen can only be used by administor, trader should not call them
	...
	/// it is not neccessary to use following 6 functions, as all these rates can be found in YDAccountInstrumentInfo
	...
	/// when trader call following 7 functions, pAccount should be NULL
	...
	///		2: protocol for api version from 1.280, current newest version
